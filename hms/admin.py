...
from .models import (
    ...
    MedicineVial, IPDBilling, OPDBilling, Payment, CustomUser,InvestigationSuggestion,AdviceSuggestion
)
...
admin_site.register(AdviceSuggestion)
admin_site.register(InvestigationSuggestion)
