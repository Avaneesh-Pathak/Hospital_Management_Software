...
urlpatterns = [
    ...
    path('emergency/add/', views.add_emergency_case, name='add_emergency_case'),
    ...
    path('emergency/admit/<int:emergency_id>/', views.admit_emergency_patient, name='admit_emergency_patient'),
